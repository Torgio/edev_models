...
export function BatteryStudyLaunch({ battery, generationIncluded, onBack, onComplete }: { battery: BatteryDraft; generationIncluded: boolean; onBack: () => void; onComplete: (runId: number) => void }) {
  ...
  return <section className="study-view" aria-labelledby="study-launch-heading">
    ...
    <div className="study-launch-grid">
      ...
      </div><p className="study-series-note">Para esta validación usa 5–6 de enero de 2026: son los dos días sintéticos disponibles en `tfm_energia_test`.</p></article>
