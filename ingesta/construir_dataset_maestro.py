...
COLS_SEGURAS_FORECAST = ["demanda_prev_mw", "gen_wind_prev_mw", "gen_solar_pv_prev_mw", "gen_renovables_prev_mw"]
...
def construir_dataset_diario(solo_filas_validas: bool = True, incluir_clima: bool = False) -> pd.DataFrame:
    ...
    piezas = [feats_fcst, feats_dia_d, cal, feats_lag_real, feats_lag_precio]
